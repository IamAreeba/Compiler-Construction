...
class SyntaxAnalyzer:
    ...
    def Default(self):
        if self.current_token[0] == 'Default':
            if self.get_next_token() and self.Body():
                return True
    ...
    def Sst(self):
        if self.current_token[0] == 'DT':
            ...
            if self.get_next_token() and self.Self():
                if self.current_token[0] == 'ID' and self.get_next_token():
                    if self.X():
                        if self.current_token[0] == ';' and self.get_next_token():
                            return True
        elif self.current_token[0] == 'Void':
    ...
    def X1(self):
        if self.current_token[0] == '.':
            ...
            if self.get_next_token() and self.OE():
                if self.current_token[0] == ']' and self.X1():
                    if self.X3():
                        return True
        elif self.current_token[0] == '(':
            if self.get_next_token() and self.Al():
                if self.current_token[0] == ')'  and self.get_next_token() and self.X2():
                    return True
